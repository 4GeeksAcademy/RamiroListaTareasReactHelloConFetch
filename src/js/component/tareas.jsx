...
const Tareas = () => {
    ...
    function Onload() {
        ...
        if (consulta == 1) {
            let inicio = prompt(`Para iniciar sesión: indique su nombre de usuario`)
            // console.log(inicio)
            getIniciar(inicio)
            // setNameRegistro(inicio)
        } else {
            let nameRegistro = prompt(`Para Registrarse: indique su nombre de usuario`)
            // console.log(nameRegistro);
        ...
        <div className="container">
            ...
            <div className="mx-auto">
                <ul className="mx-auto px-2">
                    ...
                    {/* {list.map((item, index) => (<li id="oculto" key={index} className="d-flex justify-content-between">{item[index].label}<button className="btn btn-transparent text-danger ml-5 oculto" onClick={() => removeTask(index)}>
                    X
                    </button></li>))} */}
